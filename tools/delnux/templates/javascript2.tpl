...
function %MODULE%_pages () {


	$('#pages_%MODULE%').find('.module-pages').click(function (){

		var current = $('#filters_%MODULE%').find('#page').val();
		var page    = 1;
		...
		switch ($(this).attr('id')) {
			...
			case 'end':
				page = $('#pages_%MODULE%').find('#total').val();
			break;
		}

		$('#filters_%MODULE%').find('#page').val(page);
